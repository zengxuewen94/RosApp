 ...
 * 
 */
package com.zhh.androidrosbridgeclient.ros.rosbridge;
...
import com.zhh.androidrosbridgeclient.ros.rosapi.message.*;
import com.zhh.androidrosbridgeclient.ros.rosbridge.implementation.*;
import com.zhh.androidrosbridgeclient.ros.rosbridge.operation.*;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.zhh.androidrosbridgeclient.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.zhh.androidrosbridgeclient.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                    com.zhh.androidrosbridgeclient.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.zhh.androidrosbridgeclient.ros.rosapi.message.Service(service)).type;
    }
